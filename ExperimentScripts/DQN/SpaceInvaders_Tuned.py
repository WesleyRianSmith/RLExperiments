...
experiment_name = "SpaceInvadersDQN_Tuned"
...
def CreateFolder():
    ...
    hyperparameters = {
        ...
        'verbose': 1,
        'buffer_size': 100_000,
        "learning_rate": 2.7e-05, "exploration_initial_eps": 0.030902, "exploration_final_eps": 0.02736,
        "exploration_fraction": 0.04786, "train_freq": 8
    }
