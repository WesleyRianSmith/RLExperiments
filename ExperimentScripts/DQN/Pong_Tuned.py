...
def CreateFolder():
    ...
    hyperparameters = {
        ...
        'verbose': 1,
        'buffer_size': 100_000,
        "learning_rate": 8.8e-05, "exploration_initial_eps": 0.1215, "exploration_final_eps": 0.00101,
        "exploration_fraction": 0.03571, "train_freq": 2
    }
