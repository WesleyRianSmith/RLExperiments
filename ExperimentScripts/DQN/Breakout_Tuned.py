...
experiment_name = "BreakoutDQN_Tuned"
...
def CreateFolder():
    ...
    hyperparameters = {
        ...
        'verbose': 1,
        'buffer_size': 100_000,
        "learning_rate": 8.3e-05, "exploration_initial_eps": 0.025999, "exploration_final_eps": 0.02594,
        "exploration_fraction": 0.01572, "train_freq": 8
    }
